...
export const ilceler: Ilce[] = [
  {
    ...
    metaDescription:
      "Seyhan'da 7/24 kamera izlemeli, sigortalı eşya depolama hizmeti. Ücretsiz keşif ve taşıma desteği. Adana'nın merkezinde güvenli depo çözümleri sizi bekliyor.",
...
Gürselpaşa, Yeşilyurt ve Döşeme hattındaki aileler ile Sucuzade–Kayalıbağ çevresindeki işyerleri aynı günde teslim alabiliyor. Kısa süreli tadilat deposundan uzun dönem kiralığa kadar esnek süreler sunuyor; Taşköprü ve Adana Merkez Camii çevresindeki tarihi dokuya zarar vermeden, kontrollü yükleme yapıyoruz.`,
  ...
  },
  {
    ...
    metaDescription:
      "Yüreğir'de 7/24 kamera izlemeli, sigortalı eşya depolama. Taşköprü ve Misis hattına yakın konum; ücretsiz keşif, taşıma ve güvenli depo çözümleri sunuyoruz.",
    ...
    aciklama: `Yüreğir, Seyhan Nehri'nin doğu yakasında Adana'nın en kalabalık ikinci ilçesi. Kazım Karabekir, Yavuzlar ve Haydaroğlu gibi mahallelerde aile konutu ile küçük imalathane yan yana durur; eşya depolama talebi hem ev hem iş kaynaklıdır. Sarıçam OSB'deki tesisimiz Yüreğir köprü ve çevre yolu bağlantılarıyla dakikalar içinde ulaşılır.
...
Yüzüncüyıl, Beyazevler, Huzurevleri ve Karslılar'dan Sarıçam OSB'ye gidiş çevre yolu üzerinden kısadır. Kısa dönem tadilat deposu ile yıllık kiralama aynı kapıdan yönetilir; sözleşmeyi net metrekare ve teslim tarihiyle imzalarsınız. Kurttepe ve Esentepe hattındaki villalarda bahçe mobilyası ve mevsimlik eşya için de ayrı ünite öneririz.`,
    nedenler: [
      ...
      'Çevre yoluyla Sarıçam OSB’ye kısa erişim',
    ],
    landmarks: [
      'Seyhan Baraj Gölü',
  ...
  },
  {
    ...
    metaTitle: "Sarıçam Eşya Depolama | OSB'ye Yakın Sigortalı Depo",
    metaDescription:
      "Sarıçam'da OSB'ye komşu, 7/24 kamera izlemeli sigortalı eşya depolama. Ücretsiz keşif ve taşıma. İncirlik ile üniversite çevresine aynı gün teslimat alın.",
    h1: "Sarıçam Eşya Depolama — OSB'ye Komşu Güvenli Depo",
    adHeadline: 'Sarıçam Eşya Depolama',
    seoHeadline: " — OSB'ye Komşu Güvenli Depo",
    aciklama: `Sarıçam, Adana'nın sanayi, üniversite ve yeni konut büyümesinin kesiştiği ilçedir. Tesisimiz Sarıçam OSB Mahallesi'nde; Yıldırım Beyazıt, Mehmet Akif Ersoy ve Sofulu'daki konutlardan dakikalar içinde ulaşılır. İncirlik ve Balcalı hattında görev, eğitim veya şantiye nedeniyle sık taşınanlar için kısa ve uzun dönem üniteler hazırdır.
...
Beyceli, Remzi Oğuz Arık ve İstiklal mahallelerindeki yeni sitelerde depo odası çoğu zaman yetersiz kalır. Çukurova Üniversitesi kampüsüne yakın öğrenci ve akademik personel, dönem aralarında eşyayı evde bırakmadan kiralayabilir. Sarıçam ormanları ve Çatalan Barajı yönündeki mahallelerden de aynı gün teslim planlıyoruz.`,
    nedenler: [
      'Depo tesisi Sarıçam OSB içinde, ilçeye komşu',
...
Konakoğlu, Mercimek ve Koruklu'daki aileler hasat sonrası ev düzenlemesi veya taşınma döneminde yalnızca ihtiyaç kadar metrekare kiralar. Kısa dönem ve yıllık sözleşmeler şeffaf fiyatlıdır; Ceyhan'dan yüklenen eşya aynı gün Sarıçam'daki ünitesine iner.`,
  ...
  },
  {
    ...
    aciklama: `Kozan, Sis Kalesi ve Anavarza ören yerinin gölgesinde hem tarım hem kent yaşamının sürdüğü bir ilçedir. Tufanpaşa, Arslanpaşa ve Mahmutlu'da ev yenileme, düğün evi hazırlığı veya merkeze taşınma sık görülür. Adana Sarıçam OSB'deki sigortalı depomuz, Kozan'dan planlı seferlerle bağlanır.
...
Çanaklı, Karacaoğlan ve Aslanlı mahallelerinden yükleme genellikle aynı gün tamamlanır. Kısa dönem tadilat deposu veya hasat sonrası stok için metrekareyi siz belirlersiniz; sözleşme ve teslim tutanağı şeffaftır.`,
  ...
  },
  {
    ...
    aciklama: `İmamoğlu, Adana merkez ile Kozan arasında, tarım ve küçük sanayinin iç içe geçtiği bir duraktır. Cumhuriyet ve Hürriyet mahallelerindeki konutlar ile Sayca, Alaybeyi çevresindeki evlerde depo alanı sınırlıdır. Sarıçam OSB'deki tesisimiz ilçeye araçla yaklaşık bir saatlik mesafededir; randevulu yükleme ile eşya aynı gün üniteye iner.
...
Kısa dönem (tadilat, düğün evi) ve yıllık kiralama aynı fiyat tarifesinden şeffaf ilerler. Paletli tarım malzemesi ile koltuk takımı ayrı koridorlarda saklanır; teslimde etiketli envanter teslim edilir.`,
  ...
  },
  {
    ...
    aciklama: `Karataş, Magarsus Antik Kenti, plajlar ve Akyatan–Tuzla lagünleriyle Adana'nın deniz kapısıdır. Karşıyaka, Yeni ve Ataköy'deki yazlıklar kışın kapanır; eşyayı evde bırakmak tuz, nem ve uzun boşluk riski taşır. Sarıçam OSB'deki kapalı, sigortalı ünitelerimiz mevsimlik mobilya ve ev tekstili için uygundur.
...
Kısa yaz sezonu için üç–altı aylık kiralama, kışın Adana merkezde oturanlar için yıllık kiralama mümkündür. Deniz feneri ve Kumluk Tabiat Parkı çevresindeki evlerden yükleme, randevu gününde tamamlanır.`,
  ...
  },
  {
    ...
    aciklama: `Karaisalı, Varda (Alman) Köprüsü, Kapıkaya Kanyonu ve Kızıldağ Yaylası ile Adana'nın Toros eteklerindeki merkez ilçesidir. Çevlik ve ilçe merkezindeki konutların yanında yayla evleri yazın dolar, kışın boşalır. Sarıçam OSB'deki depomuz, yayla mobilyası ve kışlık eşyayı nemden uzak, sigortalı tutar.
...
Kısa yaz sezonu veya uzun kış kiralama aynı sözleşmede net metrekareyle yazılır. Teslimde koli ve büyük parça listesi imzalanır; sezon sonunda eksiksiz iade hedeflenir.`,
  ...
  },
  {
    ...
    aciklama: `Pozantı, Adana–Ankara otoyolunun Toros geçidinde; Akçatekir, Aşar ve Armutoğlu yaylaları yazın dolar. Cumhuriyet mahallesi ve belde konutlarında depo alanı dardır; kışın boşalan yayla evlerinin eşyası merkeze indirilmek ister. Sarıçam OSB'deki sigortalı tesisimiz otoyol bağlantısıyla Pozantı'ya planlı sefer düzenler.
...
Kısa yaz sezonu kiralama ve kışın Adana'da oturanlara yıllık kiralama sunulur. Teslim envanteri sezon açılışında birebir iade için saklanır.`,
  ...
  },
  {
    ...
    aciklama: `Aladağ (Karsantı), Küp Şelaleleri ve Meydan Yaylası ile Adana'nın yüksek kesimidir. Mansurlu, Akören ve Eğner'deki evler yazın kullanılır, kışın kapanır. Sarıçam OSB'deki kapalı depomuz, yayla mobilyası ve kışlık eşyayı don ve rutubetten uzak tutar.
...
Ücretsiz keşif randevulu yapılır; dağ yolu ve hava durumuna göre araç seçilir. Kısa veya yıllık kiralama, koli ve büyük parça envanteri ile teslim alınır. Belenköy ve Akkaya hattındaki evlerden yükleme aynı seferde birleştirilebilir.`,
  ...
  },
  {
    ...
    aciklama: `Saimbeyli, Adana'nın en az nüfuslu ilçesi; Fatih ve Cumhuriyet mahalleleri ile yayla yerleşimleri yazın canlanır. Saimbeyli Kalesi (Kara Kilise) çevresindeki evlerde kışın ısınma ve nem sorunu eşyayı yıpratır. Sarıçam OSB'deki kapalı, sigortalı depo kışlık ve yazlık eşyayı ayrı tutar.
...
7/24 kamera ve ücretsiz keşif ile Değirmenciuşağı, Obruk ve Gökmenler hattından randevulu yükleme yapılır. Kısa sezon kiralama, merkeze taşınma veya uzun kış dönemi için metrekare ihtiyaca göre belirlenir.`,
  ...
  },
  {
    ...
    aciklama: `Tufanbeyli, Şar (Comana/Hieropolis) ören yeri, Alakapı ve antik tiyatrosuyla Adana'nın kuzey ucundadır. Cumhuriyet ve Yamanlı'daki konutlar ile Şar mahallesindeki evler kışın sert iklimle karşılaşır. Eşyayı Sarıçam OSB'de 7/24 kamera ve sigorta altında tutmak, don ve rutubet hasarını azaltır.
...
Ücretsiz keşif Tozlu, Pınarlar ve Kayapınar hattını da kapsar. Randevulu yükleme, koli envanteri ve esnek kiralama süresi ile yüksekova evlerinin mevsimlik döngüsüne uyum sağlanır.`,
  ...
  },
  {
    ...
    aciklama: `Yumurtalık, antik Ayas (Aigeai) kenti, Süleyman Kulesi ve lagünleriyle Adana'nın doğu kıyısıdır. Merkez, Ayas ve Zeytinli'deki yazlıklar sezon dışında boş kalır; tuzlu nem eşyayı bozar. Sarıçam OSB'deki kapalı, sigortalı üniteler mevsimlik mobilya ve ev tekstili için uygundur.
